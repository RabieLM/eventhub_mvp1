...
## Bonus MVC
- [x] `public/index.php` ajoute comme front controller
- [x] Routes MVC `/public/events`, `/public/dashboard`, `/public/events/create`
- [x] `app/Models` contient les requetes PDO
- [x] `app/Controllers` orchestre les vues, JSON, emails et PDF
- [x] `CHOIX_TECHNIQUES.md` explique l'architecture MVC
